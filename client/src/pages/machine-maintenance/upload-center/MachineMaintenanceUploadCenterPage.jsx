...
const MachineMaintenanceUploadCenterPage = () => {
  ...
  // Generate module options from machine maintenance sidebar only
  const moduleOptions = useMemo(() => {
    const excludeLabels = ["Dashboard", "Upload Center", "Download Center"];
    return machineMaintenanceSidebarItems
  ...
  return (
    ...
    >
      ...
      {/* Scrollable card grid – fixed height and overflow */}
      <Box
        sx={{
          flex: "1 1 0%", // take all remaining space
          minHeight: 0, // needed for flex child overflow
          overflowY: "auto",
          overflowX: "hidden",
          pr: { xs: 0, sm: 0.5 },
          ...hideScrollbarSx,
